...
import static surajama.droiddrop.Constants.TAG;
...
public abstract class ConnectionsActivity extends AppCompatActivity
  ...
  protected final Map<String, String> mConnectionNames = new HashMap<>();
      ...
      new PayloadCallback() {
        ...
        public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
          if (update.getStatus() == PayloadTransferUpdate.Status.SUCCESS) {
            onPayloadTransferSuccess(endpointId, update);
          }
        }
      };
  ...
  protected void disconnect(Endpoint endpoint) {
    ...
    mConnectionNames.remove(endpoint.getId());
  ...
  private void connectedToEndpoint(Endpoint endpoint) {
    ...
    mConnectionNames.put(endpoint.getId(), endpoint.getName());
